                        ...
                        <div class="sparkline13-list">
                            <div class="sparkline13-hd">
                                <div class="main-sparkline13-hd">
                                    <h1 style="text-align:center">Liste <span class="table-project-n">des</span> etudiants de formations courts du {{date_format(date_create($f->debut),'d / m / Y')}} au {{date_format(date_create($f->fin),'d / m / Y')}}</h1>
                                </div>
                                <br>
                            </div>
