    ...
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header header-color-modal bg-color-1">
                <h4 class="modal-title">Ajouter formation court</h4>
                        ...
                        <div class="sparkline13-list">
                            <div class="sparkline13-hd">
                                <div class="main-sparkline13-hd">
                                    <h1>Liste <span class="table-project-n">des</span> formations courts</h1>
                                </div>
                                <div class="add-product">
                                @if(Auth::user()->authorizeFunctions(['chef']))
                                                @else
                                    <a class="Primary mg-b-10" href="#" data-toggle="modal" data-target="#ajoutForm">Ajouter formation court</a>
                                    @endif
                                </div>
                                <br>
                            </div>
                                        ...
                                        @foreach($formations as $formation)
                                            <tr>
                                                ...
                                                <td style="text">
                                                    ...
                                                    <a href="{{ route('formations.listeEtC',[$et,$formation->id]) }}"><button data-toggle="tooltip" title="" class="pd-setting-ed" data-original-title="Liste de etudiants dans cet formation"><i class="fa fa-eye fa-lg"  aria-hidden="true"></i></button></a>
                                                @if(Auth::user()->authorizeFunctions(['chef']))
                                                @else
